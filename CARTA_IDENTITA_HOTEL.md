...
| | |
|---|---|
| **Nome** | Hotel Les Montagnards |
| **Indirizzo** | Viale della Rimembranza, 26/30 — 11017 Morgex (AO) ✅ |
| **Telefono** | +39 0165 1710000 ✅ |
...
**Spazi comuni**
- Soggiorno in stile montano elegante, con stufa in maiolica e angolo conversazione
- Sala TV
...
- Secchiata d'acqua fresca per i contrasti termici
...
- Cercano l'hotel per nome o per zona: la ricerca "hotel morgex" è la più redditizia e in crescita
- Tornano o ci sognano: il tono delle NL parte da qui

❓ Da capire: fasce d'età, coppie vs famiglie, durata media del soggiorno (il piano ipotizza 2 notti), quota di stranieri.
...
| Canale | Peso |
|---|---|
| **Telefono e WhatsApp** | **Il canale principale.** Molti aprono il booking engine e poi escono per chiamare o scrivere |
...
Poetica ma asciutta, sensoriale, in seconda persona singolare. Dettagli verificabili ("il vapore che sale nell'aria fredda", "togliersi gli scarponi"). Niente superlativi, niente urgenza inventata.
Sequenza: il fuori → *poi si rientra* → il dentro → riga sul sito ufficiale → saluto.
Dettagli in `newletter/LINEE_GUIDA_NEWSLETTER.md`.
