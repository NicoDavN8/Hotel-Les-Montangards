...
**[ IMMAGINE 1 — Lago d'Arpy con i larici dorati ]**
...
Il posto migliore per vederlo è a venti minuti da qui: si sale al **Colle San Carlo**, si lascia l'auto e in un'ora di cammino si arriva al **Lago d'Arpy**. I larici che si specchiano nell'acqua e, di fronte, tutta la catena del Monte Bianco.

Non serve essere alpinisti. Serve solo esserci nel momento giusto.

Poi si rientra, si lasciano gli scarponi all'ingresso e si scende in Spa: **la vasca idromassaggio all'aperto, con il vapore che sale nell'aria fredda**, in autunno è un'altra cosa.

È la stagione in cui Morgex torna se stessa: niente code, niente fretta, le montagne tutte per te.

Ricorda che sul nostro sito ufficiale trovi sempre la certezza delle migliori condizioni dedicate per il tuo soggiorno.
...
- **Immagine 1 (hero):** la foto del Lago d'Arpy va caricata sulla piattaforma; nell'HTML il `src` è il segnaposto `URL_IMMAGINE_LAGO_ARPY`. Alt text: *"I larici dorati del Lago d'Arpy, sopra Morgex, in autunno"*.
- **Immagine 2:** riusata dalla NL di luglio (idromassaggio esterno), già sul vostro CDN, funziona senza caricare nulla.
- **Bottone:** stesso stile della NL di luglio (#3AAEE0). Qui punta alle offerte e non alla Spa, perché l'obiettivo è la prenotazione diretta.
- **Eventi tagliati di proposito:** Tor des Géants (13–19 set), Désarpa e Marché au Fort (10–11 ott, Bard) allungavano troppo. Se servono, sono materiale per un post social o per una NL a parte a metà ottobre.
